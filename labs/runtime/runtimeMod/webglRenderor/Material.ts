...
module renderer {
    export class Material {
        ...
        constructor() {
            ...
            var nd= this.namedData = new NamedData();
            nd.add('g_Alpha', 0, NamedData.tp_f32, 1);
            nd.add('g_Color', this.color.byteOffset, NamedData.tp_fvec4, 1);
            nd.add('g_TexRange', 0, NamedData.tp_fvec4, 1);		//没有
            nd.add('g_Filter', this.shaderParam1.byteOffset, NamedData.tp_fvec4, 1);
        }
