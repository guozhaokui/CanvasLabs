...
module renderer{
    ...
    export interface WebGLExt extends WebGLRenderingContext {
        ...
        bindShaderFetch(vertexDesc: VertexDesc, gpuProgram: WebGLProgram, namedData: Array<NamedData>): ShaderLinkInfo;
        renderMesh1(mesh: Mesh, begin: number, end: number, gpuProgram: WebGLProgram,
            shaderInfo: ShaderLinkInfo, tex: Array<WebGLTexture>, cubetex: Array<WebGLTexture>, rundata: Array<ArrayBuffer>): void;
    }

    export interface VertexDesc {
    }
    ...
    export class Renderer extends WebGLRenderingContext {
        ...
        static initGlExt(webgl: WebGLRenderingContext): void {
            ...
            if (conch) {
                ...
                */
                ...
                gl.bindShaderFetch = function (vertexDesc: VertexDesc, gpuProgram: WebGLProgram, namedData: Array<NamedData>): ShaderLinkInfo {
         ...
         * @param	namedData
         */
        static bindShaderFetch(webgl: WebGLRenderingContext, vertexDesc: VertexDesc, gpuProgram: WebGLProgram, namedData: Array<NamedData>): ShaderLinkInfo{
            var gl = <WebGLExt>webgl;
            if (!gpuProgram) {
        ...
        static useMaterial(gl:WebGLRenderingContext, mtl:Material):void {
        }

        static renderMesh(gl:WebGLRenderingContext, groupData:RenderGroup, rundata:Array<ArrayBuffer>):void {
            var material:Material = groupData.material;
            var mesh:Mesh = groupData.mesh;
			...
			case Material.BLEND_TYPE_NORMAL:
                gl.blendFunc(gl.SRC_ALPHA, gl.ONE_MINUS_SRC_ALPHA);
                break;
            case Material.BLEND_TYPE_LIGHTER:
                gl.blendFunc(gl.SRC_ALPHA, gl.ONE);
                break;
            case Material.BLEND_TYPE_DARK:
                //TODO
                break;
            case Material.BLEND_TYPE_COPY:
